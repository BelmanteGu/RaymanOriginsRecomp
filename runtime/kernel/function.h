// Ponte entre imports do guest e funções C++ do host: traduz argumentos (r3..r10,
// f1..f13, pilha) e o retorno. Portado de UnleashedRecomp/kernel/function.h
// (https://github.com/hedge-dev/UnleashedRecomp, GPL-3.0); só os includes mudaram.
#pragma once
